...
<body>
    ...
    <div class="parallax-container" id="parallax-blog">
        <h1>Blog</h1>
    </div>
    ...
    <div class="ContentBox" id="blog">
        ...
        <article>
            ...
            <p>
                Herzlich Willkommen in meinem Blog! Viel Spaß beim Lesen.
            </p>
            <p>
        ...
        <article>
            ...
            // $blogID = 1;
            // do {
            //     $checkFile = file_exists("sources/txt/blog".$blogID_check.".txt");
            //     $blogID_check+1;
            // } while ($checkFile = true);
            // $read = file("sources/txt/blog".$blogID.".txt");
            // foreach ($read as $line) {echo $line;}
            // echo $blogID_check;

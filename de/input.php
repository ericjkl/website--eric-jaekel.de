...
<head>
    ...
    <meta name="description"
          content="Falls Sie Fragen, Anregungen oder ein anderes Anliegenh haben, können Sie diese hier äußern."/>
    ...
    if ($captcha_bad_response) {
        echo('
            <div class="alert alert-danger" role="alert">
                    <h2>Fehler</h2>
                    <p>Ihre Anfrage konnte nicht verifiziert werden. Möglicherweise haben Sie das reCaptcha nicht ordnungsgemäß ausgefüllt.</p>
                </div>
